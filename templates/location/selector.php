<div class="ps-location-wrapper ps-js-location-wrapper">
	<div class="ps-location ps-js-location clearfix">
		<div class="ps-location-placeholder ps-js-location-placeholder"><?php _e('Enter location name...', 'peepso-location'); ?></div>
		...
		<div class="ps-location-result ps-js-location-result">
			<div class="ps-location-header">
				...
				<span><?php _e('Select location', 'peepso-location'); ?></span>
			</div>
			<div class="ps-location-map ps-js-location-map" style="display:none"></div>
			<div class="ps-location-list ps-js-location-list"></div>
			<a href="javascript:" class="ps-btn ps-btn-small ps-btn-primary ps-js-select"><?php _e('Select', 'peepso-location'); ?></a>
			<a href="javascript:" class="ps-btn ps-btn-small ps-btn-danger ps-js-remove"><?php _e('Remove', 'peepso-location'); ?></a>
		</div>
	</div>
