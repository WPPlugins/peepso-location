<div class="ps-location-wrapper ps-js-location-wrapper" style="display:block">
	<div class="ps-location ps-js-location clearfix" style="position:relative;border:0 none">
		<input type="text" class="ps-input ps-input-full" placeholder="<?php _e('Enter location name...', 'peepso-location'); ?>" />
		...
		<div class="ps-location-result ps-js-location-result">
			...
			<a href="javascript:" class="ps-btn ps-btn-small ps-btn-primary ps-js-select" style="top:42px"><?php _e('Select', 'peepso-location'); ?></a>
			<a href="javascript:" class="ps-btn ps-btn-small ps-btn-danger ps-js-remove" style="top:42px"><?php _e('Remove', 'peepso-location'); ?></a>
		</div>
	</div>
